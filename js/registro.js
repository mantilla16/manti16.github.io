...
(function() {
    ...
    function onInputChange() {
        let f1 = document.getElementById("startDate").value;
        let f2 = document.getElementById("endDate").value;
    ...
    function loadData(page) {
        ...
        const tipoServicio = $('select[id="opctiposervicio"]').val();
            ...
            $.each(data.results, function(index, item) {
                $('#dataTable tbody').append(`
                    <tr>
                        ...
                        <input type="hidden" class="cita" value="${item.Cita}">
                        <input type="hidden" class="tercero" value="${item.tercero}">
                        <input type="hidden" class="function" value="${item.function}">
                    </tr>`
                );
            });
